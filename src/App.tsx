...
const ProfileImage = "https://yt3.googleusercontent.com/TesDTcuPlaWa9585lByYXIA4ZjkZS2zHLml5mbL1iaNgj_PGqwj25AcVXxPnZgdmFScudAHJxt8=s800-c-k-c0x00ffffff-no-rj"
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6 py-20">
        ...
        >
          <header className="text-center mb-12">
            ...
            >
              <h1 className="text-4xl font-semibold tracking-tight mb-4 text-white">Laucs</h1>
              <p className="text-neutral-500 text-lg mb-5 font-light">a person that just code stuff</p>
            ...
            <Card className="p-6 backdrop-blur-xl bg-neutral-950/60 border-neutral-800/80">
              <Accordion type="single" collapsible defaultValue="" className="w-full">
                <AccordionItem value="build">
                  ...
                  <AccordionContent>
                    Websites. I make websites. Most of my time goes into building a company.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="transition">
                  ...
                  <AccordionContent>
                    Started with HTML, CSS, and JavaScript. Switched to React. Learning React took time and effort. Now React feels natural.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="next" className="border-0">
                  <AccordionTrigger>
                    <div className="flex items-center gap-3">
